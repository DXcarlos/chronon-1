...
```bash
zipline hub run-adhoc --end-ds 2026-04-05 compiled/group_bys/aws/user_activities.recent_activity__1
```
...
```bash
zipline hub schedule compiled/group_bys/aws/user_activities.recent_activity__1
```
