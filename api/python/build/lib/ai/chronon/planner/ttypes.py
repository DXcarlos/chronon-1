    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 2:
                ...
                if ftype == TType.STRUCT:
                    self.productionJoin = ai.chronon.api.ttypes.Join()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 2:
                ...
                if ftype == TType.STRUCT:
                    self.productionJoinPart = ai.chronon.api.ttypes.JoinPart()
...
class ExternalSourceSensorNode(object):
    ...
    def __init__(self, metaData = None, sourceName = None, retryCount = None, retryIntervalMin = None,):
...
JoinMergeNode.thrift_spec = (
    ...
    None,  # 1
    (2, TType.STRUCT, 'join', [ai.chronon.api.ttypes.Join, None], None, ),  # 2
    (3, TType.STRUCT, 'productionJoin', [ai.chronon.api.ttypes.Join, None], None, ),  # 3
)
...
JoinPartNode.thrift_spec = (
    ...
    (6, TType.STRUCT, 'productionJoinPart', [ai.chronon.api.ttypes.JoinPart, None], None, ),  # 6
)
