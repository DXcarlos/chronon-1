...
struct Model {
    ...
    // Model runtime/backend details necessary to perform inference
    2: optional ModelRuntime runtime
...
struct ModelRuntime {
    1: optional ModelBackend backend
...
/**
* Inference allows us to take the output of an existing source (E.g. Event / Entity / Join) and
...
struct Train {
    ...
    5: optional string entrypoint

    // resources to use for training jobs
    6: optional Resources resources
...
struct ServingContainerConfig {
    ...
    2: optional string healthRoute

    // REST route for model inference
    3: optional string inferRoute

    // additional environment variables to pass to the serving container
    4: optional map<string, string> env
}
...
struct Serve {
    1: optional ServingContainerConfig container
    2: optional EndpointConfig endpoint
    3: optional Resources resources
    4: optional RolloutStrategy rollout
}
