...
struct Query {
    ...
    **/
    ...
    /**
    * Anchor offset of the partition grid from UTC midnight. Must be smaller than partitionInterval.
    * e.g. interval=3h, offset=1h means partition boundaries at 01:00, 04:00, ..., 22:00 UTC.
    **/
