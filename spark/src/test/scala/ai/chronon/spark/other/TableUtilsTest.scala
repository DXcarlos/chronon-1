...
class TableUtilsTest extends AnyFlatSpec {
  ...
  it should "compute watermarks in time space for sub-daily partition specs" in {
    ...
    assertTrue(tableUtils.tableCoversRange(tableName, PartitionRange("2024-01-05-04-00", "2024-01-05-04-00")(subDailySpec), Some(subDailySpec)))
    assertFalse(tableUtils.tableCoversRange(tableName, PartitionRange("2024-01-05-07-00", "2024-01-05-07-00")(subDailySpec), Some(subDailySpec)))
